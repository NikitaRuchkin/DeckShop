            ...
            <div className={styles.info__text}>
                ...
                <div className={styles.flexBoxDefault}>
                    <div className={styles.btnMargin}>
                        <Button text={'Full catalog'} imageClassName={'icon-arrow-right'} heightImage={16}/>
                    </div>
                    <Button text={'Sign up'} imageClassName={'icon-user'} heightImage={16} type={ButtonType.White}/>
                </div>
            </div>
